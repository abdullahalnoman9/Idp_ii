    ...
    <section id="carouselExampleControls" class="carousel slide carousel_section" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="carousel-image" src="./image/Hotel 02.jpg">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/Hotel 01.jpg">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/Hotel 03.png">
            </div>
            <div class="carousel-item">
                <img class="carousel-image" src="./image/Hotel 04.jpg">
            </div>
        </div>
    </section>
